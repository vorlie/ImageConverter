...
- **[Download ImageConverter.exe (GUI)](https://github.com/<username>/<repository>/releases)**
- **[Download ImageConverterCLI.exe (CLI)](https://github.com/<username>/<repository>/releases)**
